...
<section id="galeri" class="bg-gray-50 py-12 sm:py-16 px-4">
  <div class="container mx-auto">
    <div class="text-center mb-8 sm:mb-12">
      ...
      <h2 class="text-2xl sm:text-3xl font-bold text-green-700 mb-3 sm:mb-4">
        Galeri Perjalanan
      </h2>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
      ...
      <div
        ...
        <div class="h-48 sm:h-56 lg:h-48 relative overflow-hidden">
          <img src="./public/images/poster3.jpg" alt="Masjidil Haram"
      ...
      <div
        class="group relative overflow-hidden rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1">
        <div class="h-48 sm:h-56 lg:h-48 relative overflow-hidden">
          <img src="./public/images/poster3.jpg" alt="Keberangkatan Jamaah"
            class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
        </div>
        <div
          class="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300">
      ...
      <div
        class="group relative overflow-hidden rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1">
        <div class="h-48 sm:h-56 lg:h-48 relative overflow-hidden">
          <img src="./public/images/poster3.jpg" alt="Hotel Makkah"
            class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
        </div>
        <div
          class="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300">
      ...
      <div
        class="group relative overflow-hidden rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1">
        <div class="h-48 sm:h-56 lg:h-48 relative overflow-hidden">
          <img src="./public/images/poster3.jpg" alt="Kegiatan Ibadah"
            class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
        </div>
        <div
          class="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300">
      ...
      <div
        class="group relative overflow-hidden rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1">
        <div class="h-48 sm:h-56 lg:h-48 relative overflow-hidden">
          <img src="./public/images/poster3.jpg" alt="Jabal Rahmah"
            class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
        </div>
        <div
          class="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300">
      ...
      <div
        class="group relative overflow-hidden rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1">
        <div class="h-48 sm:h-56 lg:h-48 relative overflow-hidden">
          <img src="./public/images/poster3.jpg" alt="Kuliner Khas"
            class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
        </div>
        <div
          class="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300">
      ...
      <div
        class="group relative overflow-hidden rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1">
        <div class="h-48 sm:h-56 lg:h-48 relative overflow-hidden">
          <img src="./public/images/poster3.jpg" alt="Wisata Plus"
            class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
        </div>
        <div
          class="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300">
      ...
      <div
        class="group relative overflow-hidden rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1">
        <div class="h-48 sm:h-56 lg:h-48 relative overflow-hidden">
          <img src="./public/images/poster3.jpg" alt="Momen Bahagia"
            class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
        </div>
        <div
          class="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300">
