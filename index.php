  ...
  <main>
          ...
          <div class="space-y-6 lg:space-y-8">
            ...
            <div>
              ...
              <p class="text-lg sm:text-xl lg:text-2xl text-green-100 leading-relaxed mb-6 lg:mb-8">
                Bersama
                <span class="font-semibold" style="color: #1ba551">Sakha Diamond</span>, wujudkan Haji & Umroh impian
    ...
    <section class="container mx-auto py-6 px-4" id="highlight-paket">
      <div class="text-center mb-12">
        <div class="inline-flex items-center justify-center w-16 h-16 bg-green-300 rounded-full mb-4 mt-8">
      ...
      <div class="grid md:grid-cols-3 gap-8">
        <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow p-6 border-t-4 border-green-500">
          <div class="relative mb-4">
            <div class="h-48 w-full bg-gradient-to-br from-green-50 to-green-100 rounded-lg overflow-hidden">
              <img src="./public/gallery/IMG_2045.jpg" alt="Umrah Reguler"
          ...
          <div class="border-t pt-4">
            <span class="text-3xl font-bold text-green-700">Rp 25.900.000</span>
        ...
        <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow p-6 border-t-4 border-blue-500">
          <div class="relative mb-4">
            <div class="h-48 w-full bg-gradient-to-br from-green-50 to-green-100 rounded-lg overflow-hidden">
              <img src="./public/gallery/IMG_2241.jpg" alt="Umrah Reguler"
                class="h-full w-full object-cover rounded-lg hover:scale-105 transition-transform duration-300" />
            </div>
            <div
          ...
          <div class="border-t pt-4">
            <span class="text-3xl font-bold text-blue-700">Rp 31.900.000</span>
            <span class="text-gray-500 text-sm">/orang</span>
          </div>
          <a href="#paket"
          ...
          <section id="testimoni" class="bg-white py-16 px-4" x-data="{ open:false, videoUrl:'' }">
            <div class="container mx-auto">
              ...
              <div class="grid lg:grid-cols-2 gap-8 justify-center">
                ...
                <div class="bg-gradient-to-br from-green-50 to-white rounded-2xl shadow-lg p-4">
                  ...
                  <blockquote class="tiktok-embed" cite="" data-video-id="" style="max-width: 605px; min-width: 325px">
                    <section>
            ...
            <div x-show="open" x-transition @click.self="open=false"
              ...
              <div class="w-full max-w-md bg-black rounded-xl overflow-hidden">
                <iframe :src="videoUrl" class="w-full aspect-video" frameborder="0" allowfullscreen></iframe>
              </div>
            </div>
          </section>
