...
// ambil data lama dari semua_paket
$paket = mysqli_query($conn, "SELECT * FROM semua_paket WHERE id='$id'");
...
<body class="bg-gray-100 min-h-screen p-6">
    ...
    <div class="max-w-4xl mx-auto mb-6">
        <h2 class="text-3xl font-bold text-gray-800">Edit Semua Paket</h2>
        <p class="text-gray-500">Perbarui data paket (Umroh, Haji, dan lainnya)</p>
    </div>
...
if (isset($_POST['update'])) {
    ...
    mysqli_query($conn, "UPDATE semua_paket SET
        judul='$_POST[judul]',
        durasi='$_POST[durasi]',
        harga='$_POST[harga]',
