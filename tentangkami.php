...
<<<<<<< HEAD
  ...
  <nav class="bg-white shadow sticky top-0 z-50">
    <div class="container mx-auto flex items-center justify-between py-3 px-6">
      ...
      <a href="index.php" class="flex items-center gap-3">
        <img src="./public/images/logo2.png" alt="Logo Barudak Group" width="48" height="48" class="h-12 w-auto" />
      </a>
  ...
  <section class="relative h-screen">
    <img src="./public/images/umroh3.jpg" class="absolute inset-0 w-full h-full object-cover" />
...
=======
    ...
    <nav class="bg-white shadow sticky top-0 z-50">
        <div class="container mx-auto flex items-center justify-between py-3 px-6">
            ...
            <!-- Logo -->
            <a href="index.php" class="flex items-center gap-3">
                <img src="./public/logo/logo2.png" alt="Logo Barudak Group" width="48" height="48"
                    class="h-12 w-auto" />
            </a>
    ...
    <section class="container mx-auto px-4 py-16">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center bg-white rounded-3xl shadow-lg p-10">
            ...
            <div>
                <span
                    class="inline-block mb-3 px-4 py-1 rounded-full bg-green-100 text-green-700 text-xs font-semibold">
                    Tentang Kami
                </span>
    ...
    <section class="max-w-7xl mx-auto px-4 py-14">
        <div class="grid md:grid-cols-2 gap-10">
            ...
            <div class="bg-white rounded-3xl shadow-md p-8 hover:shadow-lg transition">
                <div class="flex items-center gap-3 mb-4">
                    <div
                        class="w-10 h-10 flex items-center justify-center rounded-full bg-green-100 text-green-700 font-bold">
                        V
                    </div>
                    <h3 class="text-xl font-semibold text-slate-800">Visi</h3>
                </div>
    ...
    <section class="bg-gray-100 py-6">
        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="relative w-full h-[400px] rounded-lg overflow-hidden shadow-lg">
                ...
                <!-- GOOGLE MAP EMBED -->
                <iframe src="https://www.google.com/maps?q=Cipasung&output=embed" class="w-full h-full border-0"
                    loading="lazy" referrerpolicy="no-referrer-when-downgrade">
                </iframe>

                <!-- OVERLAY LINK -->
                <a href="https://maps.app.goo.gl/dQAYdpYHuNnBJVJK9" target="_blank"
                    class="absolute inset-0 flex items-end justify-center bg-black/0 hover:bg-black/10 transition">
                    <span class="mb-4 bg-green-600 text-white px-6 py-2 rounded-full text-sm font-semibold shadow-lg">
                        📍 Buka di Google Maps
                    </span>
                </a>
